...
echo ""
echo "Next steps:"
echo "  1. Update DROPLET_URL GitHub secret to: $IP (or $DOMAIN if unchanged)"
echo "  2. Push a commit to main — GitHub Actions will deploy code, create .env, and start the webapp"
echo "  3. Verify: curl https://$DOMAIN/"
echo "  4. Check cron: ssh $SSH_USER@$IP 'tail -50 /var/log/slonk-arb/cron.log'"
